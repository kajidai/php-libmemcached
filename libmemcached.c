...
static void _get_value_from_zval(smart_str *, zval *, uint32_t *);
...
static void _get_value_from_zval(smart_str *buf, zval *var, uint32_t *flags)
{
...
PHP_FUNCTION(memcached_set)
{
    ...
    _get_value_from_zval(&buf, var, &flags);
